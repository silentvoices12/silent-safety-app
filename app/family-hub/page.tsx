...
const howToHelp = [
  ...
  { icon: "??", title: "Stay connected", body: "Isolation makes addiction worse. Keep the lines of communication open even when it is hard. A simple text saying I am here can mean everything." },
...
const boundaries = [
  { icon: "???", title: "Boundaries are not punishment", body: "Setting boundaries is an act of love — for yourself and your loved one. Boundaries protect your wellbeing and can motivate change." },
  { icon: "??", title: "Stop enabling", body: "Enabling means protecting someone from the consequences of their addiction. This includes giving money, making excuses or covering up their behaviour." },
  ...
  { icon: "??", title: "Detach with love", body: "You can love someone deeply while refusing to accept unacceptable behaviour. Detachment means stepping back from the addiction without abandoning the person." },
  ...
  { icon: "??", title: "Protect your children", body: "Children must always come first. If your loved one's addiction is putting children at risk, seek help immediately from social services or a professional." },
