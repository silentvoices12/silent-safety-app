...
const understanding = [
  ...
  { icon: "😔", title: "You did not cause this", body: "Addiction is not your fault. You did not cause it and you cannot cure it. But you can support recovery." },
  { icon: "💪", title: "Your wellbeing matters too", body: "You cannot pour from an empty cup. Taking care of yourself is essential for you and your loved one." },
];
...
const howToHelp = [
  ...
  { icon: "📞", title: "Stay connected", body: "Isolation makes addiction worse. Keep communication open even when it is hard. A simple message can mean everything." },
  { icon: "🏥", title: "Encourage professional help", body: "Gently encourage your loved one to speak to a GP or addiction specialist. Offer to go with them." },
  { icon: "🌟", title: "Celebrate every step", body: "Acknowledge and celebrate progress however small. One sober day is worth celebrating." },
  { icon: "🤝", title: "Attend support groups", body: "Al-Anon and Nar-Anon are for families and friends. Connecting with others who understand can be life changing." },
  { icon: "💊", title: "Know about naloxone", body: "If your loved one uses opioids ask a pharmacist about naloxone — a free medication that reverses overdose." },
];
...
const boundaries = [
  ...
  { icon: "🚫", title: "Stop enabling", body: "Enabling means protecting someone from the consequences of their addiction. This includes giving money or making excuses." },
  { icon: "💬", title: "Be clear and consistent", body: "State your boundaries calmly and clearly. Follow through consistently." },
  { icon: "🏠", title: "Protect your home", body: "It is reasonable to not allow alcohol or drugs in your home. Your home should be a safe space." },
  { icon: "💰", title: "Protect your finances", body: "Do not give money that could be used for substances. Pay bills directly rather than giving cash." },
  { icon: "👶", title: "Protect your children", body: "Children must always come first. If addiction is putting children at risk seek help immediately." },
];
